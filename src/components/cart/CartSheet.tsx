...
export default function CartSheet() {
  ...
  return (
    <Sheet>
      <SheetTrigger
        className="relative cursor-pointer text-gray-700 transition-colors hover:text-gray-500"
        aria-label="Cart"
      >
        ...
        {mounted && items.length === 0 ? (
          ...
          <>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center rounded border">
                          <button
                            ...
                            className="cursor-pointer px-2 py-1 text-neutral-600 hover:text-black"
                            aria-label="Decrease"
                          >
            ...
            <div className="border-t pt-4">
              ...
              <Link
                href="/checkout"
                className="mt-4 block w-full rounded-lg bg-black py-3 text-center text-sm font-medium text-white hover:bg-neutral-800"
              >
                Checkout
              </Link>
            </div>
